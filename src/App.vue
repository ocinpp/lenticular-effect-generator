...
const handleImageUpload = (type: "left" | "right", imageData: string) => {
  ...
  // Show card when both images are uploaded
...
<template>
  ...
  >
    <!-- Upload Interface -->
    <div v-if="!showCard" class="flex-1 flex flex-col animate-fade-in">
      <!-- Header -->
    ...
    <div v-if="showCard" class="h-dvh flex flex-col animate-slide-up">
      <!-- Compact Header -->
