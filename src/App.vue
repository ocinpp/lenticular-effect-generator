...
<template>
  <div class="h-screen overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex flex-col">
    <!-- Transition Overlay -->
    <div 
    ...
    >
      <div class="text-white text-center">
        ...
        <p class="text-lg">{{ showCard ? 'Preparing your lenticular card...' : 'Returning to upload...' }}</p>
      </div>
    </div>
