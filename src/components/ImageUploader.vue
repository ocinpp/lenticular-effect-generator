...
<template>
  <div class="grid md:grid-cols-2 gap-3 lg:gap-4">
    <!-- Left Image Upload -->
    <div class="space-y-2">
      <h3 class="text-base md:text-lg font-semibold text-white text-center">
        Left Image
      </h3>
      <div
      ...
      >
        <div v-if="!leftImagePreview" class="py-3">
          <div
            class="w-8 h-8 md:w-10 md:h-10 mb-2 mx-auto bg-slate-600 rounded-full flex items-center justify-center"
          >
            <svg
              class="w-4 h-4 md:w-5 md:h-5 text-slate-300"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        <div v-else class="relative">
          <img
            ...
            class="w-full h-20 md:h-24 object-cover rounded-md"
          />
          <button
